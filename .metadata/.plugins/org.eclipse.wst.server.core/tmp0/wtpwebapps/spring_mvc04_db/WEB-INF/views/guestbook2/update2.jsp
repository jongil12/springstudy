		...
		<form method="post" enctype="multipart/form-data"><!--  비밀번호니까 post로 보호 -->
			<table>
				<tr align="center">
					...
					<td><input type="text" name="name" size ="20" value="${gvo2.name }"/></td>
				</tr>
				<tr align="center">
					<td bgcolor="pink">제  목</td>
					<td><input type="text" name="subject" size ="20" value="${gvo2.subject }"/></td>
				</tr>
				<tr align="center">
					<td bgcolor="pink">email</td>
					<td><input type="text" name="email" size ="20" value="${gvo2.email}"/></td>
				</tr>
				<tr align="center">
				...
				<tfoot>
					<tr align="center">
						<td colspan="2">
							<input type="hidden" value="${gvo2.m_idx }" name="m_idx">
